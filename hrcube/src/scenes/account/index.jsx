...
const [email, setEmail] = useState("Loading...");
  ...
  return (
    <Box m="20px">
      ...
      <Box>
        <Box>
        <Box display="flex" alignItems="center" height="100%" mt="20px" mb="10px">
     
     <Typography variant="h5"  fontWeight="bold" color={colors.purpleAccent[500]} style={{ lineHeight: "1",  }}>
       Personal Information
     </Typography>
   </Box>
      <Box display="flex" alignItems="center" height="100%" mt="20px" mb="10px">
     
          <Typography variant="h5"  color={colors.purpleAccent[500]} style={{ lineHeight: "1",  }}>
            Name and Role
          </Typography>
        </Box>
      <Box display="flex" alignItems="center" height="100%" mb="20px">
          <Typography variant="h4" color={colors.primary[500]} style={{ lineHeight: "1",  }}>
